...
<div class="container-fluid py-4">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
        <div class="mb-3 mb-md-0">
            <h2 class="h4 mb-1">
                <i class="bi bi-send me-2 text-primary"></i>Pengajuan Surat Keluar
            </h2>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="/admin/ajukan/detail/<?= $row['id'] ?>" class="btn btn-sm btn-outline-info" title="Detail Pengajuan">
        ...
        function tolakPengajuan(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/admin/ajukan/tolak/' + id;
                }
            });
        }
    </script>
