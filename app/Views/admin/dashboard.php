                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <a href="/admin/surat-masuk" class="btn btn-sm btn-outline-primary">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <a href="/admin/surat-keluar" class="btn btn-sm btn-outline-primary">
                                Lihat Semua <i class="bi bi-arrow-right ms-1"></i>
                            </a>
                        </div>
            ...
            <div class="tab-content" id="documentsTabContent">
                ...
                <div class="tab-pane fade show active" id="incoming" role="tabpanel">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <a href="/admin/surat-masuk" class="btn btn-link">
                ...
                <div class="tab-pane fade" id="outgoing" role="tabpanel">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <a href="/admin/surat-keluar" class="btn btn-link">
