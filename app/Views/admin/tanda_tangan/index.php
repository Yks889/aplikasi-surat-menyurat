                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-header bg-white">
                                <h5 class="card-title fs-5 mb-0"><?= esc($ttd['nama']) ?></h5>
                            </div>
                            <div class="card-body text-center">
                                <img src="/uploads/tanda_tangan/<?= esc($ttd['file']) ?>"
                                    alt="Tanda Tangan <?= esc($ttd['nama']) ?>"
                                    class="img-fluid"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="file"
                                class="form-control <?= (session('errors.file_ttd')) ? 'is-invalid' : '' ?>"
                                id="file_ttd"
                                name="file_ttd"
                                required>
                            <div class="invalid-feedback">
                                <?= session('errors.file_ttd') ?>
                            </div>
