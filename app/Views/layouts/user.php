...
<div class="wrapper">
  ...
  <aside class="main-sidebar" id="sidebarMenu">
    ...
    <nav class="nav flex-column">
      ...
      <a href="/user/kirim-surat" class="nav-link <?= strpos(current_url(), 'kirim-surat') !== false ? 'active' : '' ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="Form Surat Masuk">
        <i class="bi bi-send"></i>
        <span>Form Surat Masuk</span>
      </a>
      <a href="/user/history-surat-masuk" class="nav-link <?= strpos(current_url(), 'history-surat-masuk') !== false ? 'active' : '' ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="History Surat Masuk">
        <i class="bi bi-clock-history"></i>
        <span>History Surat Masuk</span>
      </a>
      <a href="/user/disposisi" class="nav-link <?= strpos(current_url(), 'disposisi') !== false ? 'active' : '' ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="Disposisi Masuk">
        <i class="bi bi-inbox"></i>
        <span>Disposisi Masuk</span>
      </a>
      <a href="/user/history-pengajuan" class="nav-link <?= strpos(current_url(), 'history-pengajuan') !== false ? 'active' : '' ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="History Pengajuan">
