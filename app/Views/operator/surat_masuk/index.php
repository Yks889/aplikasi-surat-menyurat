...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <a href="/operator/surat-masuk/tambah" class="btn btn-primary btn-sm ms-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/operator/surat-masuk/edit/<?= $surat['id'] ?>" class="btn btn-sm btn-warning" title="Edit">
  ...
  <div class="modal-dialog">
    <form method="get" class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/operator/surat-masuk" class="btn btn-outline-secondary">Reset</a>
      </div>
    </form>
  </div>
</div>
