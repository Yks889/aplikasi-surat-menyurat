                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($surat['file_surat'])): ?>
                                    <a href="/uploads/surat_keluar/<?= esc($surat['file_surat']) ?>" target="_blank" class="btn btn-sm btn-outline-info" title="Lihat File">
                            ...
                            <td class="text-end">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="/operator/surat-keluar/edit/<?= $surat['id'] ?>" class="btn btn-sm btn-outline-warning" title="Edit">
    ...
    <div class="modal-dialog">
        <form method="get" class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/operator/surat-keluar" class="btn btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
</div>
